...
class Users extends CI_Model
{
	 ...
	 * @return	array
	 */
	function create_user($data, $activated = TRUE,$nama,$jabatan,$hp,$instansi)
	{
		...
		*/
		...
		if ($this->db->insert($this->table_name, $data)) {
			...
			if ($activated)	$this->create_profile($user_id,$nama,$jabatan,$hp,$instansi);
	 ...
	 * @return	bool
	 */
	private function create_profile($user_id,$nama,$jabatan,$hp,$instansi)
	{
		$domain_id = $this->encrypt->decode($instansi);
		$this->db->set('user_id', $user_id);
		$this->db->set('name', $nama);
		$this->db->set('position', $jabatan);
		$this->db->set('phone', $hp);
		$this->db->set('domain_id', $domain_id);
