		...
		<div class="col-md-12">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				else
				{
					...
					"
						<li>	
							<a href=".site_url('monitor/monitor-view-unit')."/".$monitor_encode."/".$this->uri->rsegment(4).">
							".$monitor_name."
							</a>
							<i class='fa fa-angle-right'></i>
						</li>
				...
				if(!$this->acl->hasRole(5))
				{
					...
					"
					<li>
						<a href=".site_url('monitor/single-monitor-view-unit')."/".$monitor_encode."/".$this->uri->segment(4).">
						Unit
						</a>
					<i class='fa fa-angle-right'></i>
					</li>
