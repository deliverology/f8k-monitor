	...
	<div class="row">
		<div class="col-md-12">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<?php if(isset($monitor_detil->name)) 
					echo "
					<a href='".site_url('monitor/monitor-view/'.$this->encrypt->encode($monitor_detil->id).'')."'>$monitor_detil->name</a>
					<i class='fa fa-angle-right'></i>
					";
					?>
				</li>
						...
						if($renaksi->num_rows() > 0){
							...
							echo "
								<li>
									<div class='col-md-10'>
										<blockquote>
											<h5>Tidak terdapat Rencana Aksi</h5>
										</blockquote>
									</div>
								</li>
							";
