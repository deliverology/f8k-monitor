...
<div class="modal-dialog modal-lg">
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			?>
			<?=form_open('monitor/lapor_update/'.$uc_id_encode.'', 'id="lapor"', array('class'=>'form-horizontal'));?>
			<div class="form-body">
				<div class="scroller" data-always-visible="1" data-rail-visible1="1">
					<div class="form-group">
						<label class="control-label col-md-3">Capaian
							<span class="required">
								*
							</span>
						</label>
						<div class="col-md-3">
							<div class="input-group">
								<input type="text" class="form-control" name="capaian" value="<?php echo set_value('capaian',$uc_detil->capaian) ?>"/><span class="input-group-addon"><strong>%</strong></span>
							</div>
						</div>
					</div>
					<?php
						...
						echo "	<br><br>
								...
								<div class='col-md-3'>
									<div class='input-group'>
										...
										<input type='text' class='form-control text-right' onkeyup='formatangka(this);replaceChars(document.f.a.value);' name='realisasi_keuangan' value='".set_value('realisasi_keuangan',number_format($uc_detil->realisasi_keuangan,0,',','.'))."'/>
									</div>
								</div>
							  </div>
							  <br><br>
							  <div class='form-group'>
								...
								<div class='col-md-3'>
									<div class='input-group'>
										<input type='text' class='form-control' name='realisasi_fisik' value='".set_value('realisasi_fisik',$uc_detil->realisasi_fisik)."'/><span class='input-group-addon'><strong>%</strong></span>
									</div>
								</div>
							  </div>";
					}
