...
<div class="modal-dialog modal-lg">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title"><b>Verifikasi Capaian</b></h4>
		</div>
		<div class="modal-body">
			...
			?>
			<?=form_open('monitor/verifikasi/'.$uc_id_encode.'', 'id="verifikasi"', array('class'=>'form-horizontal'));?>
			<div class="form-body">
				<div class="scroller" data-always-visible="1" data-rail-visible1="1">
					<div class="form-group">
						<label class="control-label col-md-3">Capaian <?php if($ukuran->type == 2) echo "keseluruhan";?> yang dilaporkan
							<span class="required">
								*
							</span>
						</label>
					...
					<br><br>
					<div class="form-group">
						<label class="control-label col-md-3">Hasil Verifikasi <?php if($ukuran->type == 2) echo "keseluruhan";?>
							<span class="required">
								*
							</span>
						</label>
					...
					if($ukuran->type == 2)
					{
						...
						<br><br>
						<div class='form-group'>
							<label class='control-label col-md-3'>Hasil Verifikasi Realisasi Keuangan
								<span class='required'>
									*
								</span>
							</label>
							<div class='col-md-3'>
								<div class='input-group'>
									<span class='input-group-addon'><strong>Rp</strong></span>
									<input type='text' class='form-control text-right' onkeyup='formatangka(this);replaceChars(document.f.a.value);' name='verifikasi_realisasi_keuangan' value='".set_value('verifikasi_realisasi_keuangan',number_format($uc_detil->realisasi_keuangan,0,',','.'))."'/>
								</div>
							</div>
						</div>
						<br><br>
						<div class='form-group'>
							<label class='control-label col-md-3'>Hasil Verifikasi Realisasi Fisik
								<span class='required'>
									*
								</span>
							</label>
							<div class='col-md-3'>
								<div class='input-group'>
									<input type='text' class='form-control' name='verifikasi_realisasi_fisik' value='".set_value('verifikasi_realisasi_fisik',$uc_detil->realisasi_fisik)."'/><span class='input-group-addon'><strong>%</strong></span>
								</div>
							</div>
						</div>
						";
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-icon right">
								<i class="fa"></i>
								<textarea name="keterangan" value="" class="textarea" placeholder="Keteranga / Kendala.." style="width: 590px; height: 150px"><?php echo set_value('ketarangan',$uc_detil->keterangan)."<br><b>Catatan Verifikator:</b><br>";?></textarea><br>
							</div>
						</div>
					</div>
					<br><br>
			...
			<div class="modal-footer">
				<?=form_submit('verifikasi', 'Verifikasi', 'class="btn blue"'); ?>
			</div>
			<?php echo form_close(); ?>
		</div>
	</div>
