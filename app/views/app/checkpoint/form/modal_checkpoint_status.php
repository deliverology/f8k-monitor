<script> 
    ...
    jQuery(document).ready(function() {
		...
		$('#form_checkpoint_status').ajaxForm(function(data) {
			if(data == 'success') {
				location.reload();
				} else {
...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title"><b>Status Monitor <?php echo $status_detil->monitor_name; ?></b></h4>
		</div>
		<div class="modal-body">
			...
			?>
			<?=form_open('checkpoint/checkpoint_status/'.$checkpoint_id_encode.'', 'id="form_checkpoint_status"', array('class'=>'form-horizontal'));?>
			<div class="form-body">
